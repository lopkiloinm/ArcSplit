...
// ─── Structurally identical to ReceiptDrawer ─────────────────────────────────
// "result" → verdict  |  "operators" → pipeline steps  |  rest identical
...
export function FoodReceiptDrawer({ result }: { result: FoodResult }) {
  ...
  return (
    ...
    >
      {/* Header — identical to ReceiptDrawer */}
      <div
      ...
      {/* Summary grid — same 4-stat layout as ReceiptDrawer */}
      <div className="p-4 grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          {
            label: "result",
            value: result.verdict,
            color: result.verdict === "confirmed" ? "#34d399" : result.verdict === "unconfirmed" ? "#f87171" : "#fbbf24",
          },
          {
            label: "charged",
          ...
          },
          {
            ...
            value: String(result.pipelineSteps.length),
            color: "#a78bfa",
          },
          {
      ...
      {/* Reasoning — extra section specific to food pipeline, same panel style */}
      ...
      {/* Receipt IDs — identical to ReceiptDrawer */}
      ...
      {/* On-chain links — identical to ReceiptDrawer */}
      {onChain && (
        <div
      ...
      {/* JSON log drawer — identical to ReceiptDrawer */}
      <AnimatePresence>
        {open && (
          <motion.div
